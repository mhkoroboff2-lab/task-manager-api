...
SECRET_KEY = 'django-insecure-f+rv20myu(jd3h$yewplxu*6mozk$1du7p0j1qu4#v8npl%isc'
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API для управления задачами, проектами и тегами. Поддерживает CRUD, фильтрацию и массовые операции.',
    'VERSION': '1.0.0',
